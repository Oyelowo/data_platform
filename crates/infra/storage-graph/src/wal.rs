//! WAL integration for the graph storage engine.

use std::path::Path;

use storage_wal::{Wal as RawWal, WalOptions};

use crate::format::{Metadata, WalRecord, WAL_DIR};
use crate::options::WalSyncPolicy;

/// Graph engine write-ahead log.
pub struct GraphWal {
    wal: RawWal,
...
impl GraphWal {
    ...
    pub fn checkpoint(&self, metadata: &Metadata) -> crate::Result<u64> {
